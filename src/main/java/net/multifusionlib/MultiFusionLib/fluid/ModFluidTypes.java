...
public class ModFluidTypes
{
    ...
    public static final DeferredRegister<FluidType> FLUID_TYPES =
            DeferredRegister.create(ForgeRegistries.Keys.FLUID_TYPES, MultiFusionLib.MOD_ID);

    public static final RegistryObject<FluidType> SOAP_WATER_FLUID_TYPE = registerFluidType("test_water_fluid",
